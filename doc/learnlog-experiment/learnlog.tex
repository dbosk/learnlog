...
\begin{minted}{text}
Välj ett alternativ (heltal):stdout:
1. Lägg till kontakt.stdout:
2. Sök efter kontakt.stdout:
3. Ändra en kontakt.stdout:
4. Skriv ut alla kontakterstdout:
5. Avslutastdout:
  Namn: Danielstdout:
  Tele: 0701233455stdout:
  Mail: dbosk@kth.sestdout:
  Adr : Någonannanstansstdout:
  Namn: Danielstdout:
  Tele: 0701233455stdout:
  Mail: dbosk@kth.sestdout:
  Adr : Någonannanstansstdout:
  Namn: Kawsarstdout:
  Tele: 070stdout:
  Mail: kiaa@kth.sestdout:
  Adr : Någonstansstdout:
Traceback (most recent call last):
  File "/home/dbosk/teaching/prgi25/övn-2025-11-07/contacts.py", line 228, in <module>
    main()
    ~~~~^^
